...
class PicoExtraction(Base):
    ...
    effect_size: Mapped[str | None] = mapped_column(String(200))
    confidence_interval: Mapped[str | None] = mapped_column(String(200))
    p_value: Mapped[str | None] = mapped_column(String(20))
